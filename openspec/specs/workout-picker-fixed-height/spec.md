# Spec: workout-picker-fixed-height

## Purpose

Ensure the exercise picker Dialog maintains a fixed height regardless of content changes (tab switching, search results, empty states), preventing layout jumps during interaction.
